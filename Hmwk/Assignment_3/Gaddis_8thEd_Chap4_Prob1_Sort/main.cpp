...
int main(int argc, char** argv) {
    ...
    else if(c>d && d>b && b>a){cout<<a<<" "<<b<<" "<<d<<" "<<c<<endl;}
    else if(c>b && b>d && d>a){cout<<a<<" "<<d<<" "<<b<<" "<<c<<endl;}
    else if(d>c && c>b && b>a){cout<<a<<" "<<b<<" "<<c<<" "<<d<<endl;}
    else if(d>b && b>c && c>a){cout<<a<<" "<<c<<" "<<b<<" "<<d<<endl;}
    
    //B is smallest
    if     (a>c && c>d && d>b){cout<<b<<" "<<d<<" "<<c<<" "<<a<<endl;}
    else if(a>d && d>c && c>b){cout<<b<<" "<<c<<" "<<d<<" "<<a<<endl;}
    else if(d>a && a>c && c>b){cout<<b<<" "<<c<<" "<<a<<" "<<d<<endl;}
    else if(d>c && c>a && a>b){cout<<b<<" "<<a<<" "<<c<<" "<<d<<endl;}
    else if(c>d && d>a && a>b){cout<<b<<" "<<a<<" "<<d<<" "<<c<<endl;}
    else if(c>a && a>d && d>b){cout<<b<<" "<<d<<" "<<a<<" "<<c<<endl;}
